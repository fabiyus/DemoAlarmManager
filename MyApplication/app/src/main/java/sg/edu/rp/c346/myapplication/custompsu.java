...
public class custompsu extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvTitle = (TextView) rowView.findViewById(R.id.textViewNamepsu);
        TextView tvDate = (TextView) rowView.findViewById(R.id.textViewPricepsu);
    ...
    public custompsu(Context context, int resource,
                     ArrayList<todopsu> objects) {
